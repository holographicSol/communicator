...
class App(QMainWindow):
    def __init__(self):
        ...
        self.default_decode.move(self.width - 128 - self.btn_100, 4)
        ...
        self.default_decode = QComboBox(self)
        self.default_decode.move(self.width - 128, 4)
        self.default_decode.resize(self.btn_120, 20)
        self.default_decode.setStyleSheet(cmb_menu_style)
        self.default_decode.setFont(self.font_s7b)
        self.default_decode.currentIndexChanged.connect(default_decode_function)
        ...
        for k, v in communicator_codecs.items():
            ...
            if enc_val not in enc_val_list:
                ...
                self.default_decode.addItem(str(enc_val))
        del enc_val_list
